...
export default function Home (){
  ...
  return (
    ...
    (<Link to="/" className= "btn btn-primary btn-lg">New Article</Link>):
    ('')
  }
    {/* <div>
    ...
    <div className="row">
      <div className="col-12 mb-3">
        ...
        <span id="article-count" className="ms-3 badge bg-secondary fs-6"></span>
      </div>
          ...
          <div className="col-md-6 col-lg-4 mb-4 article-card">
            {articles.map((article, idx) => (
              ...
              <div className="card-body">
                ...
                <p className="card-text">{article.content ? article.content : 'No Content'}</p>
              </div>
              <div className="card-footer bg-transparent">
                <div className="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <Link to='/' className="btn btn-outline-primary btn-sm">View Article
                  </Link>
              </div>
            </div>
            ))}
